...
$pdf->ezText("Listado de Coordinadores y vocales", 12,array('justification'=>'center'));
$pdf->ezText("\n\n\n", 10);
...
$query_autoridades_mesas="select apellido,nombre,documento from autoridades where cargo='3' or cargo='4' order by apellido";		
