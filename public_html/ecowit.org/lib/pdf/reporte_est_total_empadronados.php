...
je_regfirmas_registro r inner join je_regfirmas_padron p on r.elector=p.matricula
where 
firma='1'
order by p.nome asc";
...
$txttit= "Firmas de personas empadronadas. ";
...
$pdf->ezText("Total de firmas validas: ".$total_firmas_validas, 12);
