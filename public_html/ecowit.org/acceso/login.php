...
$query="select id_empresa,nombre,abreviatura,nom_archivo,zona,ciudad,provincia,privilegio,registrado,tipo_jugador,us,pas,profesor from usuarios_simu where us='$nombre' and pas='$pass'";
...
if ($filas==0){
		...
		$mensaje="Eror!! x - Usuario o contraseña no valido <br> ";
...

		{
			...
			switch($privilegio) {
    			...
    			case 3:
        			...
        			header("Location:../mod_profesores/menu_principal_prof.php");
					break;
			}
