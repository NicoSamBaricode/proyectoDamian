...
if($ejercicio==7){
$archivo = "mi_cuestionario.xls";
}
else
{
$archivo = "mis_decisiones_ejer_".$ejercicio.".xls";
}
...
if($_SESSION['tipo_jugador']=="Participante"){
	if($ejercicio==7){
		$server_file = "../../decisiones/cuestionario/".$nom_archivo.".xls"; 
	}
	else
	{
		$server_file = "../../decisiones/".$ejercicio."/".$nom_archivo.".xls"; 
	}
}
else
{
	if($ejercicio==7){
		$server_file = "../../decisiones_invitado/cuestionario/".$nom_archivo.".xls"; 
	}
	else
	{
		$server_file = "../../decisiones_invitado/".$ejercicio."/".$nom_archivo.".xls"; 
	}
}
...
<?php
echo "No se pudo realizar la operacion.<br>";
